...
?>
  ...
  <header class="main-header floater">
    <div class="container-fluid full-height">
        ...
        <div class="col-xl-2 col-sm-3 col-3">
          <a href="/" class="logo">
            <?php if(get_current_blog_id() == 1):?>
              ...
              <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="268.5px" height="96.9px" viewBox="0 0 268.5 96.9" style="enable-background:new 0 0 268.5 96.9;" xml:space="preserve">
                <defs>

                  <linearGradient id="con_gradient" gradientUnits="userSpaceOnUse" x1="0" y1="38.825" x2="47.782" y2="38.825" gradientTransform="matrix(1 0 0 -1 0 98)">
                    <stop offset="0" style="stop-color:#FFDE17" />
                    <stop offset="0.1951" style="stop-color:#D6B447" />
                    <stop offset="1" style="stop-color:#6B6532" />
                  </linearGradient>

                </defs>
                <g>
                  <g id="wordmark" fill="var(--wordmarkColor)">
      ...
      c-1.3,0.8-3.2,0.8-5,1.1c-1.8,0.3-3.3,0.9-3.3,3.1c0,1.8,2.3,2.4,3.8,2.4c1.8,0,4.6-0.9,4.6-3.5L223,87.1L223,87.1z" />
                  ...
                  <g id="mark">
                    <g>
                      <polygon fill="var(--brand)" points="51.7,25 82,25 82,73.7 91.8,89.4 91.8,15.1 45.4,15.1 			" />
                      <polygon fill="var(--brand)" points="76.5,86.9 20,86.9 20,27.8 10.2,17.4 10.2,96.7 85.5,96.7 			" />
                    </g>
                    <g fill="var(--logoGradient)" >

                      <path class="st1" d="M0,0h30.2l61.6,96.7L0,0z" fill="var(--logoGradient)" />
                    </g>
                  </g>
                </g>
              </svg>
              ...
              <?php else:?>
                <svg version="1.1" id="logo" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="297.274px" height="62.026px" viewBox="0 0 297.274 62.026" enable-background="new 0 0 297.274 62.026" xml:space="preserve">
                  ...
                  <use xlink:href="<?php echo get_site_url() . '/wp-content/themes/NASS-CON/src/img/logo-full.svg#wordmark_' . sanitize_title_for_query(get_bloginfo( 'name'));?>" fill="var(--brand)"></use>
            ...
            <?php if(get_current_blog_id() == 4):?>
              ...
              <div class="col-auto pr-0 pl-0">
                <a href="#" class="toggle contact">
                  <?php include get_template_directory() . '/dist/img/contact.svg';?>
                </a>
              ...
              <?php else:?>
                ...
                <?php endif;?>
                  <div class="col-auto pr-0 pl-0 search-input-wrapper">
                  ...
                  <div class="col-auto pr-0 pl-0">
                    <a href="#" class="toggle search">
                      <?php include get_template_directory() . '/dist/img/search.svg';?>
                    </a>

                  </div>
                  <div class="col-auto pr-0 pl-0">
                    <a href="#" class="toggle menu-toggle"><span></span><span class="label">Menu</span></a>

...
//            $('.floating.card.last').delay(450).remove();
...
//            $('.' + id + '').delay(100).fadeIn(300);
            ...
            //            $('.floating.card .more').fadeIn(300);
          }
        });


//        $('.timeline-container').hcSticky({
//        stickTo: '.history',
//        stickyClass: 'sticky',
...
//        followScroll: false
//        });
        //        $('.timeline li').hover(function(e){
        //          e.stopPropagation();
        //          $('.bg').not('.last').fadeOut(300);
        //          setTimeout(function(){
        //            $('.bg').not('.last').remove();
        //          }, 350);
        ////          $(this).parents('li').addClass('hover').removeClass('no-hover');
        //          $('.timeline li').removeClass('hover').removeClass('no-hover');
        //
        //
        //        });
        var autoplay = 20000;
        ...
        $('body').on('click', '.video-toggle .btn', function () {
    ...
    'single_portfolio': {
      ...
      finalize: function () {
        ...
        //        var dragging = 0;
        //
        //        $('.gallery-popup').mousedown(function() {
